...
class CarteController extends AbstractController
{
    ...
    /**
     * @Route(name="reloadCardByPhone", path="/api/reload/phone/{phone}", methods={"POST"})
     */
    ...
    /**
     * @Route(name="reloadCardByCard", path="/api/reload/card/{card}", methods={"POST"})
     */
            ...
            if ($carte) {
                if ($reload['montant'] === '' || $reload['montant'] === null) {
                    ...
                    if ($carte->getBlocked() === true) {
                        ...
                        $this->manager->persist($carte);
                        $this->manager->flush();
                        return $this->json('Reload successful');
                    }
                }
            }else {
                return $this->json('Card doesn\'t exist');
